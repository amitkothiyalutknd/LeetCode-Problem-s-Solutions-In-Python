...
class Solution:
    def intToRoman(self, num: int) -> str:
        convertDict = {"M":1000, "CM":900, "D":500, "CD":400, "C":100, "XC":90, "L":50, "XL":40, "X":10, "IX":9, "V":5, "IV":4, "I":1}
        romanNumber = ""
        while num>0:
            for _ in convertDict:
                if num >= convertDict[_]:
                    num = num - convertDict[_]
                    romanNumber += _
                    break
                else:
                    pass
...
print(f"The Roman Presenation Of Given Number:{number} Is ", sol.intToRoman(number))